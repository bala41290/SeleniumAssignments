...
public class EditLead extends PreAndPostCondition{
	...
	public void editLead(String cName, String fName, String lName, String eMail, String dName, String pNumber) throws InterruptedException {
		...
		driver.findElement(By.linkText("Edit")).click();											//Clicking on edit button after creating lead
		
		driver.findElement(By.name("description")).clear();										//Clearing the data in the description field
		
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Updated comment");		//Entering data in the important note field
		
		Thread.sleep(2000);
		
		driver.findElement(By.className("smallSubmit")).click();									//clicking on update button to update the edited data
